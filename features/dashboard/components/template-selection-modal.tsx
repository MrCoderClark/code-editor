...
const templates: TemplateOption[] = [
  ...
  },
  {
    ...
    name: "Express",
    description:
      "Fast, unopinionated, minimalist web framework for nodejs. to build APIs and web applications.",
        ...
        {step === "select" ? (
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {filteredTemplate.length > 0 ? (
                      ...
                      <div
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02] ${
                          selectedTemplate === template.id
                            ...
                            : "hover:border-[#E93F3F] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)]"
                        }`}
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto">
                              {template.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="text-xs px-2 border rounded-2xl"
                                >
                                  {tag}
                                </span>
                              ))}
                    ...
                    <div className="col-span-2 flex flex-col items-center justify-center p-8 text-center">
                      <Search size={49} className="text-gray-300 mb-4" />
              ...
              <div className="flex justify-between gap-3 mt-3 pt-3 border-t">
          ...
          <>
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#E93F3F,0_8px_20px_rgba(233,63,63,0.15)] rounded-lg border">
                <h3>Selected Template Features</h3>
